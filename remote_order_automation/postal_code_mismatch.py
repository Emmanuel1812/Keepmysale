...
def process_orders(file_path):
    ...
    for order_number in order_numbers:
        ...
        A nossa transportadora informou-nos que o endereço abaixo não é válido ou não existe:

        {info['address']}

        Poderia, por favor, confirmar se este é realmente o seu endereço?  
        Caso não seja, pedimos que nos forneça o endereço correto para que possamos enviar a sua encomenda.
...
if __name__ == "__main__":
    process_orders("postal_code_mismatch_orders.txt")
